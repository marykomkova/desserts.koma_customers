...
class Sequelize {
  ...
  constructor(database, username, password, options) {
    ...
    // TODO: get dialect name not object
    ...
    // }
    //
    // if (dialect === 'sqlite' && this.options.timezone !== '+00:00') {
    ...
    this.dialect = this.getDialectObject(this);
  ...
  /**
   * Returns a dialect object based on the current dialect.
   *
   * @returns {object} The current dialect object
   */
  getDialectObject() {
    throw new Error(
      'getDialectObject is not implemented on the base sequelize'
    );
  }
